    ...
    <Transition appear show={isOpen} as={Fragment}>
        <Dialog as='div' className='relative z-10' onClose={closeModal}>
            <Transition.Child as={Fragment} enter='ease-out duration-300' 
                                            ...
                                            leaveTo='opacity-0'>
                <div className='inset-0 bg-black fixed bg-opacity-25'/>
            </Transition.Child>
                        ...
                        <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl p-6 bg-white text-left shadow-xl transition-all flex flex-col gap-5 '>
                            ...
                            <div className='flex-1 flex flex-col gap-2'>
                                ...
                                <div className='mt-3 flex flex-wrap gap-4'>
                                    {/* map over all key and vaue pairs of the car information to display it all, not only values but also the keys*/
